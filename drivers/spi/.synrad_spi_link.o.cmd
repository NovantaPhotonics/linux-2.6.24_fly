cmd_drivers/spi/synrad_spi_link.o := ppc_4xxFP-gcc -m32 -Wp,-MD,drivers/spi/.synrad_spi_link.o.d  -nostdinc -isystem /home/mh1/MarkingHeads/amcc/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/ppc -Iarch/ppc/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -Iarch/ppc -msoft-float -pipe -ffixed-r2 -mmultiple  -mno-altivec -mstring -Wa,-m405 -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(synrad_spi_link)"  -D"KBUILD_MODNAME=KBUILD_STR(synrad_spi_link)" -c -o drivers/spi/synrad_spi_link.o drivers/spi/synrad_spi_link.c

deps_drivers/spi/synrad_spi_link.o := \
  drivers/spi/synrad_spi_link.c \
  ...
  include/asm/Flyer_Xilinx.h \
    $(wildcard include/config/major.h) \
    $(wildcard include/config/ioctl/base.h) \
...
drivers/spi/synrad_spi_link.o: $(deps_drivers/spi/synrad_spi_link.o)
