...
#define CPU_SPEC_RESTORE 40 /* offsetof(struct cpu_spec, cpu_restore)	 # */
...
#define CFG_ICACHE_BLOCKSZ 96 /* offsetof(struct vdso_data, icache_block_size)	 # */
#define CFG_DCACHE_BLOCKSZ 92 /* offsetof(struct vdso_data, dcache_block_size)	 # */
#define CFG_ICACHE_LOGBLOCKSZ 104 /* offsetof(struct vdso_data, icache_log_block_size)	 # */
#define CFG_DCACHE_LOGBLOCKSZ 100 /* offsetof(struct vdso_data, dcache_log_block_size)	 # */
