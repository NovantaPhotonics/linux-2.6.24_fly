cmd_arch/ppc/mm/init.o := ppc_4xxFP-gcc -m32 -Wp,-MD,arch/ppc/mm/.init.o.d  -nostdinc -isystem /home/mh1/MarkingHeads/amcc/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/ppc -Iarch/ppc/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -Iarch/ppc -msoft-float -pipe -ffixed-r2 -mmultiple  -mno-altivec -mstring -Wa,-m405 -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(init)"  -D"KBUILD_MODNAME=KBUILD_STR(init)" -c -o arch/ppc/mm/init.o arch/ppc/mm/init.c

deps_arch/ppc/mm/init.o := \
  arch/ppc/mm/init.c \
    $(wildcard include/config/kernel/start/bool.h) \
    $(wildcard include/config/lowmem/size/bool.h) \
    $(wildcard include/config/lowmem/size.h) \
    $(wildcard include/config/start/kernel.h) \
    $(wildcard include/config/logbuffer.h) \
    $(wildcard include/config/alt/lb/location.h) \
...
arch/ppc/mm/init.o: $(deps_arch/ppc/mm/init.o)
