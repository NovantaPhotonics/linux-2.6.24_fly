cmd_arch/ppc/lib/checksum.o := ppc_4xxFP-gcc -m32 -Wp,-MD,arch/ppc/lib/.checksum.o.d  -nostdinc -isystem /home/mh1/MarkingHeads/amcc/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/ppc -Iarch/ppc/include -D__ASSEMBLY__ -Iarch/ppc -Wa,-m405 -gdwarf-2     -c -o arch/ppc/lib/checksum.o arch/ppc/lib/checksum.S

deps_arch/ppc/lib/checksum.o := \
...
arch/ppc/lib/checksum.o: $(deps_arch/ppc/lib/checksum.o)
