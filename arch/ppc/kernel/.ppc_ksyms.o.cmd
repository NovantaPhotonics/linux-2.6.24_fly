cmd_arch/ppc/kernel/ppc_ksyms.o := ppc_4xxFP-gcc -m32 -Wp,-MD,arch/ppc/kernel/.ppc_ksyms.o.d  -nostdinc -isystem /home/mh1/MarkingHeads/amcc/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/ppc -Iarch/ppc/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -Iarch/ppc -msoft-float -pipe -ffixed-r2 -mmultiple  -mno-altivec -mstring -Wa,-m405 -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(ppc_ksyms)"  -D"KBUILD_MODNAME=KBUILD_STR(ppc_ksyms)" -c -o arch/ppc/kernel/ppc_ksyms.o arch/ppc/kernel/ppc_ksyms.c

deps_arch/ppc/kernel/ppc_ksyms.o := \
  ...
  arch/ppc/include/asm/termios.h \
  arch/ppc/include/asm/ioctls.h \
  arch/ppc/include/asm/termbits.h \
  ...
  arch/ppc/include/asm/tlbflush.h \
  include/linux/adb.h \
  ...
  arch/ppc/include/asm/backlight.h \
  include/linux/fb.h \
...
arch/ppc/kernel/ppc_ksyms.o: $(deps_arch/ppc/kernel/ppc_ksyms.o)
