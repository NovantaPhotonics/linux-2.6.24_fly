cmd_arch/ppc/kernel/traps.o := ppc_4xxFP-gcc -m32 -Wp,-MD,arch/ppc/kernel/.traps.o.d  -nostdinc -isystem /home/mh1/MarkingHeads/amcc/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/ppc -Iarch/ppc/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -Iarch/ppc -msoft-float -pipe -ffixed-r2 -mmultiple  -mno-altivec -mstring -Wa,-m405 -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(traps)"  -D"KBUILD_MODNAME=KBUILD_STR(traps)" -c -o arch/ppc/kernel/traps.o arch/ppc/kernel/traps.c

deps_arch/ppc/kernel/traps.o := \
  arch/ppc/kernel/traps.c \
    ...
    $(wildcard include/config/tau/int.h) \
    $(wildcard include/config/int/tau.h) \
  ...
  arch/ppc/include/asm/pmc.h \

arch/ppc/kernel/traps.o: $(deps_arch/ppc/kernel/traps.o)
