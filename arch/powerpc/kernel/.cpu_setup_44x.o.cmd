cmd_arch/powerpc/kernel/cpu_setup_44x.o := ppc_4xxFP-gcc -m32 -Wp,-MD,arch/powerpc/kernel/.cpu_setup_44x.o.d  -nostdinc -isystem /home/mh1/MarkingHeads/amcc/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/ppc -Iarch/ppc/include -D__ASSEMBLY__ -Iarch/ppc -Wa,-m405 -gdwarf-2     -c -o arch/powerpc/kernel/cpu_setup_44x.o arch/powerpc/kernel/cpu_setup_44x.S

deps_arch/powerpc/kernel/cpu_setup_44x.o := \
...
arch/powerpc/kernel/cpu_setup_44x.o: $(deps_arch/powerpc/kernel/cpu_setup_44x.o)
